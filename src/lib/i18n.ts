...
const dictionaries = {
  ...
  en: {
    common: {
      ...
      contact: "Contact",
      dogs: "Dogs",
      editContent: "Edit content from admin",
    ...
    footer: {
      cta:
        "If you want to help, adopt or support APADAC, go to the help section and find the way that fits you best.",
      description:
    ...
    help: {
      ...
      contactBlockWhatsapp: "WhatsApp",
      contactText:
        "If you are not sure which is the best way to help, write to us and the shelter can guide you based on what is needed right now.",
      contactTitle: "Talk to APADAC",
      diffusion: "Spread the word and help",
      ...
      donationTitle: "Financial help to sustain the day to day",
      donationWrite: "Write to collaborate",
      dogsAccount: "Donations for dogs",
      foster: "Become a foster home",
      fosterButton: "I want to foster",
      fosterText:
        "Becoming a foster home helps animals leave difficult situations and allows us to better understand their character.",
      fosterTitle: "Making room saves lives",
      optionsEyebrow: "Ways to help",
      optionsTitle: "Choose how you want to help",
      pageEyebrow: "How to help APADAC",
      pageText:
        "Choose the way of helping that fits you best and find here all the key contact and support information.",
      pageTitle: "If you cannot adopt, you can still change a life.",
      paypal: "PayPal",
      paypalButton: "Go to PayPal",
      paypalText:
        "If you prefer to donate online, you can do it directly through PayPal.",
      sponsorship: "Sponsor an animal",
      sponsorshipButton: "I want to sponsor",
      sponsorshipText:
        "Sponsorship especially helps animals with special needs, long stays or more expensive care.",
      sponsorshipTitle: "Ongoing help for special cases",
      teaming: "Join Teaming",
      teamingButton: "Go to Teaming",
      teamingLinkLabel: "Teaming link",
      teamingText:
        "With a small monthly contribution, you help sustain a stable part of the shelter's work.",
      teamingTitle: "A small monthly amount, a stable support",
      title: "How to help",
      viewOptions: "See options",
      volunteerButton: "I want to volunteer",
      volunteerText:
        "Walks, transfers, events, outreach or admin tasks. Every hour given matters.",
      volunteerTitle: "Time and hands for everyday work",
      volunteering: "Volunteer",
    },
    home: {
      adoptionEyebrow: "Available for adoption",
      adoptionText:
        "Here you can discover dogs and cats currently looking for a home, presented clearly and easy to browse.",
      announcementsAdminCta: "Create announcement",
      announcementsCta: "See all announcements",
      announcementsEyebrow: "Notice board",
      announcementsText:
        "Events, important notices and updates from APADAC gathered in one place.",
      ...
      heroText:
        "Meet the animals looking for a home, discover the adoptions that have already ended well, and find simple ways to support APADAC.",
      heroTitle: "Clear adoptions, happy endings and animals waiting for a family.",
      helpCta: "See how to help",
      helpEyebrow: "How to help",
      helpText:
        "You can support APADAC through donations, fostering, volunteering or helping spread the word.",
      helpTitle: "A small section for people who want to help in other ways",
      noAnnouncements:
        "Here we will publish events, notices and updates from APADAC as they become available.",
      noAnimals: (species: "gato" | "perro") =>
        `Soon we will show here the first ${species === "gato" ? "cats" : "dogs"} currently looking for a home.`,
      noSuccess:
        "We will share here the stories of the animals that have already found a family.",
      speciesHeading: (species: "gato" | "perro") =>
      ...
      successTitle: "Stories that already ended well",
    },
    animal: {
      adoptedOn: (date: string) => `Adopted on ${date}.`,
      adoption: "Responsible adoption",
      adoptionContact: "Adoption contact",
      adoptionQuestion: (name: string) => `Do you think ${name} could fit with you?`,
      adoptionText:
        "Write to us with a short introduction and we will tell you more about the situation, character and adoption process.",
      ...
      completeProfileText: (name: string) =>
        `You can already see the main photo and the basic details. If you would like to know ${name} better, write to us and we will gladly tell you more.`,
      detailsAdoption: "Adoption",
      ...
      sponsorStateYes: "Already has a sponsor",
      successCase: "Success story",
      tags: {
        goodWithCats: "Gets along with cats",
        goodWithDogs: "Gets along with dogs",
        goodWithKids: "Gets along with children",
        specialNeeds: "Special needs",
        sterilized: "Sterilized",
        vaccinated: "Vaccinated",
      },
      viewOtherAnimals: "See other animals for adoption",
      writeAbout: (name: string) => `Write about ${name}`,
    },
    adoptionList: {
      allFemale: "All",
      ...
      pageText:
        "Here you will find the animals currently available, with the essential information needed to begin the adoption process.",
    },
    sponsorPage: {
      ...
      emptyText:
        "At the moment all animals already have support. You can still browse adoptions or discover other ways to help APADAC.",
    ...
    successPage: {
      ...
      subtitle:
        "This section brings together completed adoptions and shows the impact of APADAC's daily work.",
      title: "Animals that have already found a family",
      viewStory: "See story",
    },
    announcementsPage: {
